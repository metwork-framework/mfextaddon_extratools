...
if test -f "${BUILDCACHE}/build_hash_mfextaddon_extratools_${BRANCH}_`cat .build_hash`"; then
...
rm -f ${BUILDCACHE}/build_hash_mfextaddon_extratools_${BRANCH}_*
hash_file=${BUILDCACHE}/build_hash_mfextaddon_extratools_${BRANCH}_`cat .build_hash`
touch ${hash_file}
rm -f ./build_hash
